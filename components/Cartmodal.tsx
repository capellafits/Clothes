...
function CartContent() {
  ...
  return (
    <>
      <div
        className={`fixed inset-0 z-[60] transition-all duration-300 cursor-pointer ${
      ...
      <div
        className={`fixed right-0 top-0 h-dvh w-[90%] max-w-sm sm:w-96 bg-white shadow-2xl z-[70] flex flex-col overflow-hidden transition-all duration-300 ease-out ${
          isAnimating
      ...
      >
        <div className="flex items-center justify-between shrink-0 p-4 sm:p-6 border-b border-gray-200 bg-white sticky top-0 z-10">
        ...
        {items.length > 0 && (
          <div
            className="px-4 py-3 sm:px-6 border-t border-gray-200 space-y-2 bg-gray-50 shrink-0 z-10 transition-all duration-300"
            style={{
              borderTopLeftRadius: '24px',
